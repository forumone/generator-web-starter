...
export interface ComposerSchema {
  ...
  config?: {
    ...
    lock?: boolean;
    /**
     * Defaults to true. If set to false, Composer will not create and require a platform_check.php file as part of the autoloader bootstrap.
     */
    'platform-check'?: boolean;
    [k: string]: unknown;
  };
  /**
